...
while ($cont <= $total_sequencias) {
    ...
    $b = 0;
    while ($n <= 54) {
        if($dezena1 <> $n && $dezena2 <> $n && $dezena3 <> $n && $dezena4 <> $n && $dezena5 <> $n  && $dezena6 <> $n+$b){
            $globo7[$n] = $n+$b;
            $n=$n+1; 
        }else{
            $b=$b+1;
    ...
    $rand_keys_7 = array_rand($globo7, 1);
    $dezena7 = $globo7[$rand_keys_7];


    $a = 0;

    while (!($dezena1 < $dezena2 && $dezena2 < $dezena3 && $dezena3 < $dezena4 && $dezena4 < $dezena5 && $dezena5 < $dezena6 && $dezena6 < $dezena7)) {
        if ($dezena1 > $dezena2) {
            $a = $dezena2;
            $dezena2 = $dezena1;
            $dezena1 = $a;
    ...
    echo "$dezena1 $dezena2 $dezena3 $dezena4 $dezena5 $dezena6 $dezena7";

    echo "<br>";
    fwrite($fp, "$dezena1 $dezena2 $dezena3 $dezena4 $dezena5 $dezena6 $dezena7\n");
